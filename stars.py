...
long = 0.014573
west_east = W
quick_locations = {'Hobart':[42.8826*S,147.3257*E],'Isfield':[50.935391*N,0.066639*E],'Uckfield':[50.975185*N,0.103074*E],'Greenwich':[51.476275*N,0.017379*W],
...
draw.ellipse(((w-width)/2, (h*positions_dict[text_loc][2]-height/2)+207,
              (w+width)/2, (h*positions_dict[text_loc][2]+height/2)+207), fill=255)
...
if data_type == 'stars':
    ...
    map_image.paste(solid_image, (0,positions_dict[text_loc][3]+207), mask = dial_image)
...
if key_label_none == 'key' and include_planets:
    ...
    for i,line in enumerate(line_list):
        text_w, text_h = draw.textsize(text=line,font=myFont)
        if text_loc == 'none':
            break;
